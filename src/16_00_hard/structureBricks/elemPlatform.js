...
import { COLOR_00, H, W, THICKNESS_PLATFORM, COLOR_01, COLOR_02 } from './constants'
...
export const createPlatformData = ({
    ...
    const col = []
    /** sides ***/
    const colorPolygon = M.fillColorFace(COLOR_02)
    const colorPolygonTop = M.fillColorFace(COLOR_01)
    const colorSide = [
        ...colorPolygon,
    ]
    /** top part **/
