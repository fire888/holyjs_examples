...
const choiceFinalTileFromExists = (dataAction, map) => {
    ...
    if (mapItem.maybeTilesInds.length === 0) {
...
const createPipelineActionsWithMapItem = (y, z, x) => {
    const actions = [
            ...
            return new Promise(res => {
                ...
                createMap3X(tiles, dataStructure, studio).then(mapR => {
                    ...
                    const pipelineActions = (y, z, x, map) => {
                        return new Promise(res => {
                            const actions = createPipelineActionsWithMapItem(y, z, x)
                            const iterateAction = (indAction) => {
                                ...
                                // }
                                // f = () => {
                                //     console.log('map', map.items[y][z][x])
